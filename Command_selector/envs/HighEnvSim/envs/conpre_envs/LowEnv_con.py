...
class LowCommandEnv(object):
    ...
    def reset_machine(self):
        ...
        # 定义敌方飞机的基准位置（单位：米）
        enemy_pairs = {
            1: {'base_position': (4500, 5000), 'formation_offset': [(-300, 0), (300, 0)]},  # 正北7km，V型队形
            2: {'base_position': (-8000, 0), 'formation_offset': [(0, -300), (0, 300)]},  # 正西7km，垂直队形
            3: {'base_position': (7000, -5000), 'formation_offset': [(-300, 300), (300, -300)]}  # 东南7km-5km，斜向队形
        }
    ...
    def load_low_model(self):
        """加载预训练模型参数"""
        self.attack_model_path = ("D:\Jin\Meta_Command\Experiment\Paper\Final\CS_human\cs_human_control\envs"
                                  "\HighEnvSim\low_models\models\\attack\level_v3\\actor_latest.pt")
        self.escape_model_path = ("D:\Jin\Meta_Command\Experiment\Paper\Final\CS_human\cs_human_control\envs"
