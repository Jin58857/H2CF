...
class AttackLowActor(nn.Module):
    def __init__(self, act_space, device=torch.device("cpu")):
        super(AttackLowActor, self).__init__()
        # 网络配置
        self.gain = 0.01
...
class EscapeLowActor(nn.Module):
    def __init__(self, act_space, device=torch.device("cpu")):
        super(EscapeLowActor, self).__init__()
        # 网络配置
        self.gain = 0.01
        self.hidden_size = '128'
        self.act_hidden_size = '128 128'
