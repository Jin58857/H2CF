...
def parse_args(args, parser):
    ...
    parser.add_argument("--exp_class", type=str, default="train2", help="exp is train or test")

    parser.add_argument("--env_name", type=str, default="AirCombatEnv", help="Which envs to run on")
    parser.add_argument("--task_name", type=str, default="mappo-v7-level2", help="Which task to run on")
