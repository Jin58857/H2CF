...
def _get_prepare_config(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--env-platform", type=str, default='HarFang',
                       help="specify the name of environment")
    group.add_argument("--algorithm-name", type=str, default='mappo', choices=["ppo", "mappo"],
                       help="Specifiy the algorithm (default ppo)")
    group.add_argument("--experiment-name", type=str, default="Attack",
    ...
    group.add_argument("--n-training-threads", type=int, default=12,
                       help="Number of torch threads for training (default 1)")
    group.add_argument("--n-rollout-threads", type=int, default=12,
    ...
    group.add_argument("--model-dir", type=str, default=None,
                       help="Path to pretrained model (redacted in public release; must be provided explicitly).")
    ...
    group.add_argument("--user-name", type=str, default='jincl',
                       help="for setprobtitle use")
    group.add_argument("--wandb-name", type=str, default='jincl',
...
def _get_replaybuffer_config(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--buffer-size", type=int, default=9000,
...
def _get_network_config(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--hidden-size", type=str, default='128',
...
def _get_recurrent_config(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--use-recurrent-policy", action='store_false', default=False,
...
def _get_ppo_config(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--ppo-epoch", type=int, default=8,
    ...
    group.add_argument("--entropy-coef", type=float, default=5e-3,
...
def _get_log_config(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--log-interval", type=int, default=2,
