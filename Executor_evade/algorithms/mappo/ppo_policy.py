...
class PPOPolicy:
    ...
    def act2(self, obs, rnn_states_actor, masks, deterministic=False):
        """
        Returns:
            actions, rnn_states_actor
        """
        actions, _, rnn_states_actor, attn_weights = self.actor.forward_2(obs, rnn_states_actor, masks, deterministic)
        return actions, rnn_states_actor, attn_weights
